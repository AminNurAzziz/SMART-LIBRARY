...
// sections
import PaymentAnalytic from './PaymentAnalytic';
import PaymentHistoryTableRow from './PaymentHistoryTableRow';
import PaymentHistoryTableToolbar from './PaymentHistoryTableToolbar';
...
export default function PaymentHistoryPage() {
  ...
  const TABS = [
    ...
    { value: 'pending', label: 'Pending', color: 'default', count: getLengthByStatus('draft') },
  ] as const;
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <Card>
          ...
          <PaymentHistoryTableToolbar
            ...
            onFilterStartDate={(newValue: (Date | null)) => {
